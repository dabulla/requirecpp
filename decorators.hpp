 ...
 * Others can require the component during destruction. If it is a
 * reregisterable component, calls to require will wait. If it is not a
 * reregisterable component, the call to require will fail and throw. If the
 * application hangs on exit due to
 */
// template<typename T>
...
//{
//     //static_assert(std::is_base_of<ComponentStateDecoration, T>, "Do not
//     Decorate with multiple Component States");
// };
//// do not block and immediatly return a component, but block on first usage of
///the component
// template<typename T>
...
//{
//     //static_assert(std::is_base_of<FailureDecoration, T>, "Do not Decorate
//     with multiple Component States");
// };
...
//{
//     //static_assert(std::is_base_of<LockModifyDecoration, T>, "Do not
//     Decorate with multiple Component States");
// };

//// return a reference to a component or throw. This is basic ServiceLocator
///style
// template<typename T>
...
//// If the component was destroyed, the call will throw. This should not be
///used, / calls to the component will be slow and it must be expected, that
///every call could throw / This is discouraged for the same reasons as
